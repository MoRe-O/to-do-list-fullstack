...
export default function Navbar({ sortBy, onSort, onOpenPopover, onSearch }) {

    return (
        <div className="flex flex-row gap-[16px]">
            <div className="relative flex items-center px-5 gap-3 rounded-2xl border border-white/20 w-[300px] grow backdrop-blur-md bg-white/10 shadow-[0px 3px 4px 0px rgba(1, 5, 3, 0.1)]">
                <input onChange={(e) => onSearch(e.target.value)} id="searchField" placeholder="Search note..." className="w-full caret-white text-white focus:outline-none"/>
                <button className="cursor-pointer text-white ">
                    <svg width="21" height="22" viewBox="0 0 21 22" fill="transparent" xmlns="http://www.w3.org/2000/svg">
            ...
            <button
                ...
                className="border border-white/20 backdrop-blur-md bg-white/10 p-1.5 rounded-full cursor-pointer"
            >
            ...
            <select value={sortBy} onChange={onSort} className="w-auto bg-prpl rounded-[5px] text-white p-1.5 font-bold cursor-pointer">
